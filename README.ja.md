...
*This is the Japanese version of [`README.md`](README.md). The English
version is the reference; the rest of the documentation is in English.*
...
[ロードマップ](docs/architecture.md#roadmap)を参照．自動テストは本物の ACME CA や
